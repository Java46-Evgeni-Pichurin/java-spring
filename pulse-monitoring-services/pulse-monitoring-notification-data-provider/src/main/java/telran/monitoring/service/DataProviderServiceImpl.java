...
public class DataProviderServiceImpl implements DataProviderService {
    ...
    public NotificationData getNotificationData(long patientId) {
        ...
        String doctorName = doctorRepository.findById(doctorEmail).isPresent() ?
                doctorRepository.findById(doctorEmail).get().getName() : "";
        String patientName = patientRepository.findById(patientId).isPresent() ?
